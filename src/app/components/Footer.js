    ...
    <footer className="relative pt-20 pb-10 overflow-hidden bg-gray-900">
      ...
      <div className="relative bg-gray-900 pt-20">
        <div className="container mx-auto px-4">
          ...
          {/* Main Footer Content */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-10 mt-16">
            <div>
              <div className="mb-6">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">Historiegränd 8A, 907 34 Umeå</span>
                </li>
                <li className="flex items-start">
                  ...
                  <span className="text-gray-300">+46704969578</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-primary-indigo-light mr-3 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                  </svg>
                  <span className="text-gray-300">sherry.khann@icloud.com</span>
                </li>
              </ul>
            </div>
          </div>
